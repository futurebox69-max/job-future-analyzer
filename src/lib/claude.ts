...
=== 필수 JSON 형식 ===
{
  ...
  "dimensions": {
    "repetitive": { "score": 숫자, "label": "반복적 업무", "description": "자동화 대상 업무 2가지와 현재 기술 수준 (60자 이상)", "icon": "🔄" },
    "cognitive": { "score": 숫자, "label": "인지적 판단", "description": "AI 대체 가능한 판단과 불가능한 판단 구분 (60자 이상)", "icon": "🧠" },
    "physical": { "score": 숫자, "label": "신체적 작업", "description": "로봇화 가능한 작업과 현재 기술 한계 (60자 이상)", "icon": "💪" },
    "creative": { "score": 숫자, "label": "창의성/감성", "description": "창의·감성 비중과 AI 한계 (60자 이상)", "icon": "🎨" },
    "social": { "score": 숫자, "label": "대인관계", "description": "신뢰·공감·협상 업무 예시와 AI 대체 한계 (60자 이상)", "icon": "🤝" },
    "ethical": { "score": 숫자, "label": "윤리/법적", "description": "윤리·법적 책임 상황과 AI 위임 불가 이유 (60자 이상)", "icon": "⚖️" },
    "techVelocity": { "score": 숫자, "label": "기술 변화 속도", "description": "이 분야 AI 발전 속도와 주요 기술 동향 (60자 이상)", "icon": "⚡" },
    "regulatory": { "score": 숫자, "label": "제도적 보호막", "description": "면허·규제의 구체적 내용과 AI 대체 방어 메커니즘 (60자 이상)", "icon": "🛡️" }
  },
  "iceberg": [
    { "level": 1, "title": "현상 (지금 눈에 보이는 것)", "content": "현재 AI/자동화로 일어나는 구체적 변화 (2-3문장)", "depth": "surface" },
    { "level": 2, "title": "패턴 (지난 5년의 흐름)", "content": "2020~현재 변화 추세와 3년 예상 (2-3문장)", "depth": "shallow" },
    { "level": 3, "title": "구조 (이 변화를 만드는 시스템)", "content": "경제·기술·노동시장 구조가 이 직업을 바꾸는 방식 (2-3문장)", "depth": "deep" },
    { "level": 4, "title": "전제 (근본 믿음과 패러다임)", "content": "이 직업을 지탱하는 사회적 가정이 AI 시대에 도전받는 방식 (2-3문장)", "depth": "root" }
  ],
  "transitions": [
    {
      "type": "이직",
  ...
  "timeHorizon": {
    ...
    "narrative": "현재~10년 변화 스토리. 기술 발전 시점과 고용 변화 포함 (3문장)"
  },
  "skillGap": {
  ...
  "consultingNote": "이 직업 종사자에게 전달할 핵심 메시지. 'AI를 가장 잘 다루는 전문가가 되는 것이 생존 전략'임을 구체적으로. AI 활용 예시, 취해야 할 태도와 행동 포함. (4-5문장)"
}`;
