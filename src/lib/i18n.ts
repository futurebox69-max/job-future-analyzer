...
export const UI_STRINGS: Record<LangCode, {
  ...
  ko: {
    title: "내 직업의 미래",
    subtitle_adult: "내 직업의 변화를 여덟 개의 눈으로 읽고, 지금 준비할 것을 보여드립니다",
    subtitle_youth: "관심 직업의 변화를 구조로 읽고 진로를 설계하세요",
    mode_adult: "성인",
    mode_youth: "청소년",
    ...
    empty_sub: "여덟 개의 눈 · 10년 예측 · 스킬 로드맵 · 소득 영향",
    remaining: "오늘 남은 횟수",
    instant: "즉시 로드",
    share_btn: "결과 공유하기",
    share_title: "결과 공유하기",
    save_image: "이미지로 저장 (인스타·틱톡용)",
    copy_link: "링크 + 텍스트 복사",
    copied: "복사됨!",
  ...
  en: {
    ...
    save_image: "Save Image (for Instagram·TikTok)",
  ...
  zh: {
    ...
    share_btn: "分享结果",
    share_title: "分享结果",
    save_image: "保存图片（用于Instagram·TikTok）",
    copy_link: "复制链接+文字",
    copied: "已复制！",
  ...
  ja: {
    ...
    share_btn: "結果をシェア",
    share_title: "結果をシェア",
    save_image: "画像を保存（Instagram·TikTok用）",
  ...
  es: {
    ...
    save_image: "Guardar Imagen (para Instagram·TikTok)",
