...
const LABELS: Record<LangCode, {
  ...
  en: {
    ...
    safe_label: "Human Strengths (higher = safer)",
  ...
  es: {
    ...
    safe_label: "Fortalezas Humanas (más alto = más seguro)",
